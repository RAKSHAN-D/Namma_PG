        ...
        const fetchData = async () => {
            try {
                const [
                    ...
                    AdminService.getAccountStatusOverview()
                ]);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                >
                    <div>
                        <p className="text-sm font-medium text-gray-500 group-hover:text-amber-600 transition-colors">Pending Approvals</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {/* New: User vs Owner Onboarding Trend (Grouped Bar Chart) */}
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                {/* PG Stats & Account Status (Split Column) */}
                                ...
                                <div key={item.name}>
                                    ...
                                    <div className="w-full bg-gray-100 rounded-full h-2">
                                        <div
                                            ...
                                            style={{ width: `${(item.value / 200) * 100}%`, backgroundColor: item.fill }}
                                        ></div>
                                    </div>
                                </div>
                            ))}
